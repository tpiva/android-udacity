...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar mLoaginContentProgressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoaginContentProgressBar = (ProgressBar) findViewById(R.id.pb_loading_content);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute() {
            mLoaginContentProgressBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            mLoaginContentProgressBar.setVisibility(View.INVISIBLE);
            if (weatherData != null) {
